...
class User implements UserInterface
{
    ...
    {
        $this->licenseRequests = new ArrayCollection();
     ...
     * @Assert\Length(min=8, minMessage="Votre mot de passe doit comporter au minimum {{ limit }} caractères")
     */
    private $password;
    ...
    public function getConfirmPassword(): ?string { return $this->confirm_password; }

...
class ClientAuthenticator extends AbstractFormLoginAuthenticator
{
    ...
    {
        return $request->attributes->get('_route') === 'client_login' && $request->isMethod('POST');
    }
    ...
    {
        return $this->entityManager->getRepository(Client::class)->findOneBy(['email' => $credentials['email']]);
    }

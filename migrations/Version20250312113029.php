...
final class Version20250312113029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD category_id INT NOT NULL, DROP stock');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD stock VARCHAR(255) NOT NULL, DROP category_id');
    }
}
